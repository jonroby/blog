...
class Navbar extends Component {
  ...
  render() {
    ...
    let styles =
      postsPage || homePage ? postsStyles : postPage ? postStyles : aboutStyles;

    return (
      <div className="navbar-container" style={styles}>
        <div className="navbar">
          <div
            id={postsPage || postPage ? "navbar-active-tab" : ""}
            className="navbar-posts"
          >
          ...
          <div
            id={aboutPage ? "navbar-active-tab" : ""}
